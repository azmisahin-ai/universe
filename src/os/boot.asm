...
Main16:
    ...
    mov bx, 0x1000     ; Yükleyeceğimiz bellek adresi: 0x1000'den itibaren
    ; mov bx, 0x0000  ; Bellek adresi (0x0000:0x7E00
    int 0x13           ; Disk okuma çağrısı

    jc disk_error      ; Hata durumunda disk_error işaretçisine git

    jmp 0x1000:0000    ; Kernel'in başlangıç adresine atla (0x1000:0000)
    ; İşletim sistemi kernel'ini başlat
    ; jmp 0x0000:0x7E00  ; Kernel'in başlangıç adresine atla
...
; Ekrana mesaj yazdıran fonksiyon
PrintMessage:
...
diskErrorMessage db 'Disk okuma hatası!', 0
